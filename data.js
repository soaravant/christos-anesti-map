...
export const GREETING_COUNTRIES = [
    {
        ...
        greetingPronunciation: 'Χριστός Ανέστη!',
        responsePronunciation: 'Αληθώς Ανέστη!',
        ttsLang: 'el',
    ...
    },
    {
        ...
        greetingPronunciation: 'Κρίστι ου νγκιάλ!',
        responsePronunciation: 'Βέρτετ ου νγκιάλ!',
        ttsLang: 'sq',
    ...
    },
    {
        ...
        greetingPronunciation: 'Χρίστος α ινβιάτ!',
        responsePronunciation: 'Αντεβεράτ α ινβιάτ!',
        ttsLang: 'ro',
    ...
    },
    {
        ...
        greetingPronunciation: 'Χρίστος βαζκρέσε!',
        responsePronunciation: 'Βοΐστινα βαζκρέσε!',
        ttsLang: 'bg',
    ...
    },
    {
        ...
        greetingPronunciation: 'Χρίστος βάσκρσε!',
        responsePronunciation: 'Βαΐστινου βάσκρσε!',
        ttsLang: 'sr',
    ...
    },
    {
        ...
        greetingPronunciation: 'Χριστός βοσκρέσε!',
        responsePronunciation: 'Βοΐστινα βοσκρέσε!',
        ttsLang: 'ru',
    ...
    },
    {
        ...
        greetingPronunciation: 'Χριστός βοσκρές!',
        responsePronunciation: 'Βοΐστινου βοσκρές!',
        ttsLang: 'uk',
    ...
    },
    {
        ...
        greetingPronunciation: 'Κρίστο α ρεσουσιτάδο!',
        responsePronunciation: 'Εν βερδάδ α ρεσουσιτάδο!',
        ttsLang: 'es',
    ...
    },
    {
        ...
        greetingPronunciation: 'Κρίστο ρεσουσιτόου!',
        responsePronunciation: 'Εμ βερντάδε ρεσουσιτόου!',
        ttsLang: 'pt',
    ...
    },
    {
        ...
        greeting: 'المسيح قام!',
        response: 'حقا قام!',
        greetingPronunciation: 'Αλ Μασίχ κάμ!',
        responsePronunciation: 'Χάκκαν κάμ!',
        ttsLang: 'ar',
        ttsText: 'المسيح قام!',
    ...
    },
    {
        ...
        greetingPronunciation: 'Κρίστο αμεφουφούκα!',
        responsePronunciation: 'Κουέλι αμεφουφούκα!',
        ttsLang: 'sw',
    ...
    },
    {
        ...
        greetingPronunciation: 'Κρίστους τελά μπανγκίτ!',
        responsePronunciation: 'Ντία μπενάρ μπενάρ τελά μπανγκίτ!',
        ttsLang: 'id',
